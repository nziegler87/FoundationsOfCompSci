...
turn = input("Who goes first? Yellow or Red?\n").lower()

while True:
    
    location = int(input("Your turn, " + turn.upper() + ": Where " +
                         "do you want to put your piece?\n"))

    while location not in piece_dict.keys():
        location = int(input("Your turn, " + turn.upper() + ": Where " +
                             "do you want to put your piece?\n"))
